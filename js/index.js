...
function fun() {
    ...
    localStorage.setItem("obj"+idcount.toString(),JSON.stringify(obj));
    localStorage.setItem("idcount",parseInt(idcount)+1);
}
function reqfun(obj){
...
let myPromise = new Promise(function(myResolve, myReject) {
  ...
  myPromise.then(
    function(value) {localStorage.setItem("img"+localStorage.getItem('idcount'),value);}
  );